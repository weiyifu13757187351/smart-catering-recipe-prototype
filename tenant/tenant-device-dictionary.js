(()=>{
  ...
  const types=[['tags','菜谱标签'],['cooking','烹饪分类'],['province','菜谱省份'],['cuisine','菜系分类'],['process','工艺处理']];
  // 字典编码前缀按字典类型唯一分配，避免省份与工艺处理都取到 PR。
  const idPrefix={tags:'TG',cooking:'CK',province:'PV',cuisine:'CU',process:'PR'};
  const filters={tags:'',cooking:'',province:'',cuisine:'',processType:'',processName:''};
